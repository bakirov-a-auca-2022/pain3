...
std::shared_ptr<HuffmanNode> construct_huffman_tree(std::set<std::shared_ptr<HuffmanNode>, CompareNode>& all_letter_nodes){
...
int main(){
    std::string file = read_file("../ex_text.txt");
    ...
    output_bin(encoded_message, "../encoded_text.bin");
    output_codes(codes, "../encoded_pairs.txt");
}